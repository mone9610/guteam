...
## 利用規約
この利用規約（以下，「本規約」といいます。）は，サイト運営者（以下，「当方」といいます。）が愚痴〜ム（以下，「本サービス」といいます。）の利用条件を定めるものです。  
登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。  
また、本サービスを開始した時点で、利用規約に同意したものとみなします。
...
## 第4条（利用料金および支払方法）
1. ユーザーは，本サービスの利用料金を支払う必要がないことを承知するものとします。
## 第5条（禁止事項）
...
10. 以下の表現を含み，または含むと当方が判断する内容を本サービス上に投稿し，または送信する行為
    ...
    5. その他反社会的な内容を含み、過度に他人に不快感を与える表現
11. 以下を目的とし，または目的とすると当方が判断する行為
    ...
    5. 当方，本サービスの他のユーザー，または第三者に不利益，損害または過度な不快感を与えることを目的とする行為
...
退会手続きは、当面の間はSNS等を通じた当方への連絡とするものとします。
